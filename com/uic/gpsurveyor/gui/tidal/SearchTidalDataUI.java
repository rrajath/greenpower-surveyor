...
import com.uic.gpsurveyor.service.tidal.SearchTidalDataService;
 ...
 *
 */
public class SearchTidalDataUI extends JFrame{

	private JPanel contentPane;
	private JTextField txtCity;
	private JTextField txtCounty;
	private JTextField txtState;
	private ArrayList alTidalPowerList;

	/**
	 * Create the frame.
	 */
	public void showSearchPage() {
		setTitle("Search Tidal Data");
		setVisible(true);
		setResizable(false);
		...
		JLabel lblSearchCrit = new JLabel("SEARCH TIDAL DATA");
		...
		btnSearch.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					...
					htParams.put("TidalPowerVO", objTidalPowerVO);

					alTidalPowerList = SearchTidalDataService.execute(htParams);

					TidalPowerListUI objTidalPowerListUI = new TidalPowerListUI();
					objTidalPowerListUI.showTidalPowerList(alTidalPowerList);
					setVisible(false);
		...
		JButton btnAdd = new JButton("ADD TIDAL DATA");
		...
		btnAdd.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				setVisible(false);
				if(Scratchpad.ht.get("TidalPowerVO") != null)
				{
					Scratchpad.ht.remove("TidalPowerVO");
				}
				InsertTidalUI itui =new InsertTidalUI();
				itui.showInsertTidalPage();
				itui.setVisible(true);
				//	showPanel();
