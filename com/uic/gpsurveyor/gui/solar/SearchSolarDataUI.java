...
import com.uic.gpsurveyor.service.solar.SearchSolarDataService;
 ...
 *
 */
public class SearchSolarDataUI extends JFrame{

	private JPanel contentPane;
	private JTextField txtCity;
	private JTextField txtCounty;
	private JTextField txtState;
	private ArrayList alSolarPowerList;

	/**
	 * Create the frame.
	 */
	public void showSearchPage() {
		setTitle("Search Solar Data");
		setVisible(true);
		setResizable(false);
		...
		JLabel lblSearchCrit = new JLabel("SEARCH SOLAR DATA");
		...
		btnSearch.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				try {
					...
					objSolarPowerVO.setCity(txtCity.getText());
					objSolarPowerVO.setCounty(txtCounty.getText());
					objSolarPowerVO.setState(txtState.getText());

					htParams.put("SolarPowerVO", objSolarPowerVO);

					alSolarPowerList = SearchSolarDataService.execute(htParams);

					SolarPowerListUI objSolarPowerListUI = new SolarPowerListUI();
					objSolarPowerListUI.showSolarPowerList(alSolarPowerList);
					setVisible(false);
		...
		JButton btnAdd = new JButton("ADD SOLAR DATA");
		...
		btnAdd.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				setVisible(false);
				if(Scratchpad.ht.get("SolarPowerVO") != null)
				{
					Scratchpad.ht.remove("SolarPowerVO");
				}
				InsertSolarUI isui =new InsertSolarUI();
				isui.showInsertSolarPage();
